...
function dbToMonthly(rows) {
  ...
  rows.forEach(r => {
    m[`${r.ac_id}|${r.year}|${r.month}`] = {
      ...
      volsDec1: Number(r.vols_dec_1pax) || 0,
      volsDec2: Number(r.vols_dec_2pax) || 0,
      volsDec3: Number(r.vols_dec_3pax) || 0,
    };
  });
  return m;
}
...
export function useFleetData() {
  ...
  const setMonthly = useCallback(async (acId, year, month, fields) => {
    ...
    const merged = {
      heures: fields.heures !== undefined ? fields.heures : (existing.heures || 0),
      rotations: fields.rotations !== undefined ? fields.rotations : (existing.rotations || 0),
      heuresDc: fields.heuresDc !== undefined ? fields.heuresDc : (existing.heuresDc || 0),
      heuresDecouverte: fields.heuresDecouverte !== undefined ? fields.heuresDecouverte : (existing.heuresDecouverte || 0),
      heuresInitiation: fields.heuresInitiation !== undefined ? fields.heuresInitiation : (existing.heuresInitiation || 0),
      heuresBia: fields.heuresBia !== undefined ? fields.heuresBia : (existing.heuresBia || 0),
      litresCarburant: fields.litresCarburant !== undefined ? fields.litresCarburant : (existing.litresCarburant || 0),
      volsDec1: fields.volsDec1 !== undefined ? fields.volsDec1 : (existing.volsDec1 || 0),
      volsDec2: fields.volsDec2 !== undefined ? fields.volsDec2 : (existing.volsDec2 || 0),
      volsDec3: fields.volsDec3 !== undefined ? fields.volsDec3 : (existing.volsDec3 || 0),
    };
    const dbRow = {
      ...
      vols_dec_1pax: merged.volsDec1,
      vols_dec_2pax: merged.volsDec2,
      vols_dec_3pax: merged.volsDec3,
    };

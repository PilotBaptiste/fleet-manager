...
const COL_MAP = {
  ...
  terrainDep: ["terrain dep", "terrain départ", "terrain depart"],
  terrainArr: ["terrain arr", "terrain arrivée", "terrain arrivee"],
  atterrissages: ["atterrissage", "atterrissages", "att", "nbr att"],
  carbuDepart: ["carburant départ", "carburant depart", "carbu départ", "carbu depart", "carburant départ en litre", "carburant_depart", "carburant depart"],
  carbuArrivee: ["carburant arrivée", "carburant arrivee", "carbu arrivée", "carbu arrivee", "carburant arrivée en litre", "carburant_arrivée", "carburant arrivée"],
  huile: ["huile", "huile en litre"],
  horametreDepart: ["horamètre1 départ", "horametre1 depart", "horamètre départ", "horametre depart"],
  horametreArrivee: ["horamètre1 arrivée", "horametre1 arrivee", "horamètre arrivée", "horametre arrivee"],

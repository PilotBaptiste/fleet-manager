...
export function calcMonth(data, acId, y, m) {
  ...
  // Vol BIA : coût variable par vol, saisie directe du revenu total
  ...
  return {
    ...
    volsDec1pax, volsDec2pax, volsDec3pax, volsDecouverte, volsInitiation, volsBia,
    tarif, tarifDec1, tarifDec2, tarifDec3, tarifInit,
    revenu, revenuVol, revenuVolCdb, revenuVolDc, revenuPilote,
    revenuDecouverte, revenuInitiation, revenuBia,
...
const AGG_KEYS = ["heures","rotations","hCdb","hDc","hDec","hInit","hBia","heuresPilote","volsDec1pax","volsDec2pax","volsDec3pax","volsDecouverte","volsInitiation","volsBia","revenu","revenuVol","revenuVolCdb","revenuVolDc","revenuPilote","revenuDecouverte","revenuInitiation","revenuBia","litresCarburant","variable","depenses","depensesNormales","resultat","resultatRecurrent","loan","opsC","opsCNormal","opsCExceptional","carburant"];
...
export function calcMonthWithOverrides(data, acId, y, m, overrides) {
  ...
  const rateFields = ["tarifHeure","tarifDec1pax","tarifDec2pax","tarifDec3pax","tarifInitiation","consoCarburant","consoHuile"];
